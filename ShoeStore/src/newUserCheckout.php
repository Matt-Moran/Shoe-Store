...
<head>
    ...
    <style>
        input[type=text], input[type=password], .levelselect {
            width: 100%;
            padding: 12px 20px;
            margin: 8px 0;
...
<body>
    ...
    echo "<div class='table_container'><form action='processCheckout.php' method='post' name='newUser'><table>
            <tr>
                <th>Brand</th>
                <th>Shoe Name</th>
                <th>Cost</th>
    ...
    //User Information
    echo "<div class='login_container'><h3>New User Personal Information</h3>";
    echo    "<label for='fname'><b>First Name</b></label>
            ...
            <label for='level'><b>Level   </b><a href='about_us.php#jump_here'>(More About Levels)</a></label>
            <select name='level' class='levelselect' required>
